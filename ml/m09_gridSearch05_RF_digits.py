from sklearn.model_selection import train_test_split, cross_val_score, cross_val_predict, KFold, StratifiedKFold, GridSearchCV # 격자탐색, Cross_Validation
...
# 최적의 매개변수 : RandomForestClassifier(min_samples_split=3, n_jobs=8)
# 최적의 파라미터 : {'min_samples_split': 3, 'n_jobs': 8}
# best_score : 0.9749564459930313
# model.score : 0.9805555555555555
# accuracy_score : 0.9805555555555555
# 최적 튠 ACC : 0.9805555555555555
# 걸린시간 : 62.21754598617554