...
최적의 매개변수 : RandomForestClassifier(min_samples_leaf=7, min_samples_split=10, n_jobs=-1)
최적의 파라미터 : {'n_jobs': -1, 'min_samples_split': 10, 'min_samples_leaf': 7}
best_score : 0.9444444444444443
model.score : 1.0
accuracy_score : 1.0
최적 튠 ACC : 1.0
걸린시간 : 2.6080174446105957
"""
