...
# 최적의 매개변수 : RandomForestRegressor(min_samples_leaf=7, min_samples_split=5, n_estimators=300, n_jobs=4)
# 최적의 파라미터 : {'n_jobs': 4, 'n_estimators': 300, 'min_samples_split': 5, 'min_samples_leaf': 7}
# best_score : 0.3408142529621906
# model.score : 0.35704123743744065
# accuracy_score : 0.35704123743744065
# 최적 튠 ACC : 0.35704123743744065
# 걸린시간 : 14.944350242614746
