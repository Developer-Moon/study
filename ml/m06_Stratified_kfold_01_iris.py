...
from sklearn.model_selection import train_test_split, KFold, cross_val_score, StratifiedKFold  # Kfold - cross_val_score검증하기위해 이걸 쓴다
...
kfold = StratifiedKFold(n_splits=n_splits, shuffle=True, random_state=66 )      # y값이 3개라면 
