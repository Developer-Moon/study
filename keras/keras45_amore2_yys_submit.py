...
# 1. 데이터
dataset_sam = pd.read_csv('./_data/test_amore_0718/samsung.csv', thousands=',', encoding='cp949')
dataset_amo = pd.read_csv('./_data/test_amore_0718/amore.csv', thousands=',', encoding='cp949')
