...
#3. 컴파일, 훈련
model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy'])  #  validation_split=0.2
hist = model.fit(xy_train[0][0], xy_train[0][1], epochs=100, validation_data=xy_test, validation_steps=4) # x와 y가 하나로 되어있다 배치사이즈를 최대로 잡으면 이거도 가능
...
# loss :  1.1538761555129895e-06
# val_loss :  3.816887378692627
# acc :  1.0
