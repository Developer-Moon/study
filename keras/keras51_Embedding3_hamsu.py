...
# model.add(Embedding(input_dim=31, output_dim=11, input_length=5)) # 임베딩을 거치면 통상 3차원이 나온다 
# model.add(LSTM(32))                            
# model.add(Dense(1, activation='sigmoid')) # 0, 1을 구분해서 sigmoid
# model.summary()

input_01 = Input(shape=(5,))
embedding_01 = Embedding(31, 10, input_length=5)(input_01)
lstm_01 = LSTM(32)(embedding_01)
output_01 = Dense(1)(lstm_01)
