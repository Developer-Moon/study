...
np.save('d:/study_data/_save/_npy/kears_46_05_train_x.npy', arr=xy_train[0][0]) # train_x이 numpy파일로 저장
np.save('d:/study_data/_save/_npy/kears_46_05_train_y.npy', arr=xy_train[0][1]) # train_y
np.save('d:/study_data/_save/_npy/kears_46_05_test_x.npy', arr=xy_test[0][0])  # test_x
np.save('d:/study_data/_save/_npy/kears_46_05_test_y.npy', arr=xy_test[0][1])  # test_y
