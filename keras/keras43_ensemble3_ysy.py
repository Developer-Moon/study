...
model = Model(inputs=[input_01, input_02, input_03], outputs=[last_output01, last_output02]) # intput이 2개 이상이라 list
model.summary()
...
model.fit([x1_train, x2_train, x3_train], [y1_train, y2_train], epochs=300, batch_size=10, validation_split=0.2)
