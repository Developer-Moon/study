...
dropout_01 = Dropout(0.5)(dense_02)
...
dense_07 = Dense(100, activation='sigmoid')(dropout_02)
dense_08 = Dense(100)(dense_07)
dropout_03 = Dropout(0.2)(dense_08)
output_01 = Dense(1, activation='sigmoid')(dropout_03)
