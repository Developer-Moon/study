...
hist = model.fit(x_train, y_train, epochs=50, batch_size=10, validation_split=0.2) # hist = history 
...
plt.plot(hist.history['loss'], marker='.', c='red', label='loss')           # marker= 수치부분 .으로 표시 c='red' 그래프를 붉은컬러로  label='loss' 이그래프의 이름(label)은 loss
