...
#2. 모델구성
input_01 = Input(shape=(54,))
dense_01 = Dense(500)(input_01)
dense_02 = Dense(500)(dense_01)
dense_03 = Dense(500)(dense_02)
dense_04 = Dense(500)(dense_03)
dense_05 = Dense(500)(dense_04)
output_01 = Dense(7, activation='softmax')(dense_05)
...
loss     :  0.6416857838630676      함수모델 사용 
val_loss :
mae      : 
val_mae  :                          loss :  0.6418493986129761
acc스코어 : 0.7219116067051228      accuracy :  0.7204773426055908
"""""""""""""""""""""""""""""""""
"""""""""""""""""""""""""""""""""
[scaler = StandardScaler]           
