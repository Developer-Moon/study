...
dense_05 = Dense(140, activation='relu')(dense_04)
...
dense_10 = Dense(150, activation='relu')(dense_09)
...
dense_15 = Dense(150, activation='relu')(dense_14)
...
[scaler = MinMaxScaler]
                                          함수모델 사용
loss     : 29.081787109375         
val_loss :
mae      : 
val_mae  :                                loss : 31.16085433959961
r2스코어 : 0.7602982634083626              r2스코어 : 0.7131749461413023
"""""""""""""""""""""""""""""""""
"""""""""""""""""""""""""""""""""
[scaler = StandardScaler]           
