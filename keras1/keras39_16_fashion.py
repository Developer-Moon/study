...
model = Sequential()
model.add(LSTM(units=10, activation='relu', input_shape=(28*28, 3)))
...
hist = model.fit(x_train, y_train, epochs=1, batch_size=2000, validation_split=0.2, callbacks=[earlyStopping], verbose=1)  
