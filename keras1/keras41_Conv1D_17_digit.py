...
print(x_train.shape) # (1203, 64)
print(x_test.shape)  # (594, 64)

x_train = x_train.reshape(1203, 64, 1)
x_test = x_test.reshape(594, 64, 1)
...
# Conv1D
# loss :  0.2989926040172577
# accuracy :  0.936026930809021
