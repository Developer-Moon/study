...
from tensorflow.python.keras.layers import Dense, Dropout, Input, Conv2D, MaxPooling2D, Flatten, LSTM
...
#2. 모델구성
model = Sequential()
model.add(LSTM(units=50, activation='relu', input_shape=(10, 1))) # 최대넓이가 가로13 세로 1이라 커널 사이즈 최대가 (1, 1)이 된다                                                                          
...
# LSTM
# 07421875, 5106.67333984375]
# r2스코어 : 0.10963540066223065