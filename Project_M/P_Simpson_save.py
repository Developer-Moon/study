...
np.save('d:/study_data/_data/Project_M/20220725_Simpson/_npy/test_x.npy', arr =x_test)
np.save('d:/study_data/_data/Project_M/20220725_Simpson/_npy/test_y.npy', arr =y_test)
print('End')
