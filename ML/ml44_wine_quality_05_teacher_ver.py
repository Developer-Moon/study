...
newlist = []
for i in y: # y의 3부터 9까지 의 값들이 들어간다
    if i<=5: 
        newlist += [0]
    elif i==6:
        newlist += [1]
...
x_train, x_test, y_train, y_test = train_test_split(x, newlist, train_size=0.8, random_state=123, stratify=y)
...
# model.score : 0.7683673469387755
# acc_score : 0.7683673469387755
# f1_score(macro) : 0.7708546514107955
# f1_score(micro) : 0.7683673469387755
