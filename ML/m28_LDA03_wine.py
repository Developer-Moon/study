...
print(np.unique(y, return_counts=True)) # (array([0, 1, 2])
...
# LDA - column:13, array:3, n_components=2
# 결과 : 1.0
# time : 0.5088551044464111


# LDA - column:13, array:3, n_components=1
# 결과 : 0.9722222222222222
# time : 0.5130023956298828
