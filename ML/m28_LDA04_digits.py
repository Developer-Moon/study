...
# LDA - column:64, array:10, n_components=9 
# 결과 : 0.9777777777777777
# time : 1.3855836391448975

# LDA - column:64, array:10, n_components=1 n_components를 줄일수록 점점 낮아진다
# 결과 : 0.42777777777777776
# time : 1.3577539920806885
