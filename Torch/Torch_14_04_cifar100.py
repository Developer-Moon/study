...
train_dataset = CIFAR100(path, train=True, download=True) # download=False
test_dataset = CIFAR100(path, train=False, download=False) # download=False
...
# epoch : 21, loss : 3.3920, acc : 0.187, val_loss : 3.4684, val_acc : 0.176